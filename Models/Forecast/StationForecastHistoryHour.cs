...
{
    /// <summary>
    /// 换热站负荷预测历史小时表（StationForecastHistoryHour）
    /// </summary>
    public class StationForecastHistoryHour
    {
        /// <summary>
        /// 自增Id
        /// </summary>
        ...
        /// 预测时间
        /// </summary>
        public DateTime ForecastDateHour { get; set; }
        ...
        /// 小时用热量
        /// </summary>
        public decimal HourlyHeatHour { get; set; }
