...
{
    public class StationForecastHistoryHourService: DbContextSqlSugar
    {
        /// <summary>
        /// 查询历史信息小时表信息
        /// </summary>
        ...
        {
            var totalCount = 0;
            var list = Db.Queryable<StationForecastHistoryHour,StationBranch>((s, sbr) => new object[] { JoinType.Left, s.VpnUserId == sbr.VpnUser_id && s.StationBranchArrayNumber == sbr.StationBranchArrayNumber })
